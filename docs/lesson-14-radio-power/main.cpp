...
#define BTN_WIFI  12   // the OTHER half of the 16 rocker (re-found 2026-07-21); triggers WiFi
...
void loop() {
  ...
  if (g12Prev && !g12) {                                           // press begins
    ...
    g12Down = 0; g12Prev = g12; runBleService(); return;          // HOLD -> BLE
  } else if (!g12Prev && g12) {                                    // released
    uint32_t held = millis() - g12Down; g12Down = 0;
    if (held >= 40 && held < 700) { g12Prev = g12; runWifiAP(); return; }  // TAP -> WiFi
  }
  g12Prev = g12;
